...
<div id="bp-nouveau-activity-form-placeholder" class="bp-nouveau-activity-form-placeholder-<?php if ( !bp_is_active( 'media' ) ){ echo ' media-off'; } ?> custom-placeholder"></div>
